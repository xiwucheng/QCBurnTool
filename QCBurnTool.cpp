...
BEGIN_MESSAGE_MAP(CQCBurnToolApp, CWinApp)
...
// 唯一的一个 CQCBurnToolApp 对象

CQCBurnToolApp theApp;


// CQCBurnToolApp 初始化

BOOL CQCBurnToolApp::InitInstance()
{
